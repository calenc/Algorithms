    ...
    */
    class MaxHeap
    {
        ...
        public MaxHeap(int totalSize)
        {
            ...
            h = new int[totalSize + 1];      // array to hold the int objects of the heap.
        } // end MaxHeap(int)
        ...
        public void Insert(int item)
        {
            ...
            {
                int temp = -1;               // temporary value to hold our place and swap nodes correctly.
        ...
        {
            int temp = -1;   // temporary int so we can swap the first and last elements in the array.
            ...
            while (current <= size / 2 && h[current] < h[current * 2] || current <= size / 2 && h[current] < h[current * 2 + 1])
            {
                int firstChild = h[current * 2];           // store the first child node as a char value.
                int secondChild = h[current * 2 + 1];      // store the second child node as a char value.
                ...
                if (h[current] == h[childSpot])
                {
                    current = current / 2;
                    break;
                }

                if (h[childSpot] > h[current])
                {
                    int holder = -1;     // temporary int to hold the value of the parent that we need to switch.
        ...
        public void Heap_Flush()
        {
            ...
            h = new int[max_size];      // create an empty array to flush out the current container.
        } // end Heap_Flush()
    } // end MaxHeap
} // end Project4
